describe('Sacler Steps Component', () => {
  beforeEach(() => {
    cy.visit('/iframe.html?args=&id=navigation-scaler-steps--scaler-steps&viewMode=story');
  });

  it('should display the scaler-steps title', () => {
    cy.get('[class*="display-5"]').contains('Phasellus').should('exist');
  });

  it('should display the scaler-steps body text', () => {
